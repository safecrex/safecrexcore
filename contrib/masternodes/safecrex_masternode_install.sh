...
COIN_TGZ="https://github.com/safecrex-official/safecrex/releases/download/v1.0.0.1/safecrexcore-1.0.0-linux${KERN_ARCH}.tar.gz"
...
function install_sentinel() {
  ...
  local SENTINEL_PATH="sentinel-safecrex"
  cd $CONFIGHOME
  git clone https://github.com/safecrex-official/sentinel.git $SENTINEL_PATH
  cd $SENTINEL_PATH
