...
2. run safecrexd with -printalert or -sendalert like this:
   /path/to/safecrexd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.safecrex.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Safecrex Core:0.12.0.58/"));
