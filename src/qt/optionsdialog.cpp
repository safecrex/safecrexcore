    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SFCXASH-light"), QVariant("light"));
    ui->theme->addItem(QString("SFCXASH-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("SFCXASH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SFCXASH-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SFCXASH-traditional"), QVariant("trad"));
