    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Safecrex Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Safecrex address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and safecrex: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Safecrex Core"), this);
    aboutAction->setStatusTip(tr("Show information about Safecrex Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Safecrex Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Safecrex addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Safecrex addresses"));
    ...
    openAction->setStatusTip(tr("Open a safecrex: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Safecrex Core help message to get a list with possible Safecrex Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Safecrex Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Safecrex network", "", count));
    } else {
...
{
    QString strTitle = tr("Safecrex Core"); // default title
