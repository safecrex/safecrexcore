...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Safecrex Core safecrex-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  safecrex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded safecrex transaction") + "\n" +
              "  safecrex-tx [options] -create [commands]   " + _("Create hex-encoded safecrex transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded safecrex transaction
