...
#define BOOST_TEST_MODULE Safecrex Test Suite

#include "test_safecrex.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_safecrex_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
