...
Only requiring some minor changes is safecrex.cpp.
...
Changes to safecrex.cpp
----------------------
safecrex.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
