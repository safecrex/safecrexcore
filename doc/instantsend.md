...
This mechanism has been integrated into Bitcore-Node-Safecrex which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/safecrex-official/insight-api-safecrex#web-socket-api](https://github.com/safecrex-official/insight-api-safecrex#web-socket-api)
* API: [https://github.com/safecrex-official/insight-api-safecrex#instantsend-transactions](https://github.com/safecrex-official/insight-api-safecrex#instantsend-transactions)
...
By default, the Safecrex Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Safecrex Core daemon:
