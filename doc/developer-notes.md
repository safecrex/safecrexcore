...
Safecrex Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 9792.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 9791 for connections and services them.
...
However, in open source software such as Safecrex Core, where everyone uses
...
pay attention to for reviewers of Safecrex Core code.

General Safecrex Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Safecrex Core uses tinyformat, which is type safe. Leave them out to avoid confusion
